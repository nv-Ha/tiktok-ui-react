export const SentIcon = ({ width = '2.2rem', height = '2.2rem', className }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const ChangeIcon = ({ width = '2.2rem', height = '2.2rem', className }) => (
    <svg
        fill="currentColor"
        fontSize="26px"
        viewBox="0 0 48 48"
...
export const BoxIcon = ({ width = '2.2rem', height = '2.2rem', className }) => (
    <svg
